...
public partial class Auth_View_Team : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("selectTeam", MyCon);
    ...
    protected void gridlist_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Response.Redirect("add-edit-Team.aspx");
        }
        if (e.CommandName == "Activate")
        {
            string cmd1 = "update tblTeam set Status='1' where id=" + e.CommandArgument;
        ...
        {
            string cmd1 = "update tblTeam set Status='0' where id=" + e.CommandArgument;
            SqlCommand cmd = new SqlCommand(cmd1, MyCon);
            MyCon.Open();
            cmd.ExecuteNonQuery();
            MyCon.Close();
