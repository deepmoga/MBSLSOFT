...
public partial class Auth_Deactive : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        dt = objsql.GetTable("select r.id,r.name,r.rollno,r.fathername,r.phone,s.roomid,r.image from tblstudentdata r , student_course s  where r.rollno=s.rollno and r.status='0' Order By id desc");
        if (dt.Rows.Count > 0)
        {
    ...
    protected void ListView2_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        {
            objsql.ExecuteNonQuery("update tblstudentdata set status='1' where id=" + e.CommandArgument);
        }
        BindData();
    }
}