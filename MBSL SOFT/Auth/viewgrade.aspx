<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="viewgrade.aspx.cs" Inherits="Auth_viewgrade" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpmain" Runat="Server">
 <asp:Label ID="lblcode" runat="server" Text="" Visible="false"></asp:Label>
  ...
  <div class="col-md-12">
<asp:DataGrid ID="gridlist" runat="server" Width="100%" AutoGenerateColumns="false" onitemcommand="gridlist_ItemCommand" class="table table-bordered">
 <Columns>
            <asp:TemplateColumn >
                <HeaderTemplate>
                    ID</HeaderTemplate>
            ...
            <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("MaxPercantage")%></div>
        ...
        <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("MinPercantage")%></div>
        ...
        <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("Grade")%></div>
         ...
         <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("G_Type")%></div>
