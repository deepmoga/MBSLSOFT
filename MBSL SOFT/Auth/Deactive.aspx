<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="Deactive.aspx.cs" Inherits="Auth_Deactive" %>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th>
                            <input type="text" class="form-control" placeholder="Level"></th>
                        <th>
                            <input type="text" class="form-control" disabled="disabled" placeholder="Pic"></th>
                        <th>
                            <input type="text" class="form-control" disabled="disabled" placeholder="Action"></th>
                    </tr>
                </thead>
                <tbody>
                    <asp:ListView ID="ListView2" runat="server" OnItemCommand="ListView2_ItemCommand" >
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ToolTip="View & Edit Details" ForeColor="white" CommandName="edit" CssClass="label label-info" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"id") %>'
                   Text="View" runat="server"></asp:LinkButton>
                                                                            <asp:LinkButton ID="LinkButton3" CommandName="deactive" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Id") %>' runat="server" CssClass="label label-success">Active</asp:LinkButton>
